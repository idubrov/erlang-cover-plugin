 ...
 */
public final class CoverPublisherTarget {
    ...
    /**
     * Constructs a new CoverPublisherTarget.
     */
    public CoverPublisherTarget() {
    }
     ...
     * @stapler-constructor
     */
    public CoverPublisherTarget(CoverageMetric metric, Float healthy, Float unhealthy, Float unstable) {
        this.metric = metric;
